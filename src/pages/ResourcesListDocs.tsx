...
export default function ResourcesListDocs() {
  return (
    <>
      <Seo title="Resources List | StratAI" description="Documentation for the Resources footer list including showcase, API, usage, accessibility, responsive testing, and performance." />
