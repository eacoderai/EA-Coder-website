...
export default function Tutorials() {
  return (
    <>
      <Seo title="Video Tutorials | EACoder AI" description="Video tutorials for EACoder AI usage and best practices." />
      <DocLayout title="Video Tutorials" subtitle="Learn how to use the platform">
        <div className="rounded-xl border bg-card px-6 py-6">
          ...
          <p className="text-sm text-gray-600">Overview of creating and testing strategies with EACoder AI.</p>
        </div>
        <div className="rounded-xl border bg-card px-6 py-6">
